    ...
    <div class="acknowledgements-section">
      ...
      <div class="acknowledgements-content">
        <p class="acknowledgements-text">
          特别感谢所有在我的成长道路上给予支持和帮助的朋友们。是你们的鼓励、分享和协作，让这个博客得以存在并不断发展。
          每一次交流、每一次讨论，都为我提供了宝贵的学习和成长机会。
        </p>
        <p class="acknowledgements-text">
          首先我要感觉@cuijunjie18，他是真正带我入门计算机科学的人。从他的笔记本里，我知道了如何去记录平常遇到的问题，去热爱计算机科学这门学科。在与他的交流中，我开始萌生出写博客的想法。
        </p>
        <p class="acknowledgements-text">
        ...
        <p class="acknowledgements-text">
          再次感谢所有在路上遇见的人，感谢所有帮助过我的人，感谢所有鼓励过我的人。
        </p>
      </div>
    </div>
  </div>
